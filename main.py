...
def main():
    # ---------- Text génération ----------
    # texte = IAGeneration.Creator() # Generate a text with IA
    ...
    # picturegeneration.GeneratePicture("Red bike in the forest") 
    # Faire un commentaire RP pour simuler la publication de l'image avec la verification par le certifier
    PictureAIorNot("test_wm.png")
